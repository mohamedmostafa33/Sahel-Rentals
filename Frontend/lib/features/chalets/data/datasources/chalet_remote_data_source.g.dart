...
class _ChaletRemoteDataSource implements ChaletRemoteDataSource {
  _ChaletRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<ChaletModel>> getChalets() async {
    ...
    final _options = _setStreamType<List<ChaletModel>>(
    ...
    try {
      _value =
          _result.data!
              .map(
                (dynamic i) => ChaletModel.fromJson(i as Map<String, dynamic>),
              )
              .toList();
    } on Object catch (e, s) {
  ...
  Future<ChaletModel> getChaletDetail(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ChaletModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
  ...
  @override
  Future<ChaletModel> updateChalet(int id, ChaletUpdateRequest request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = request;
  ...
  Future<ChaletImageUploadResponse> uploadChaletImages(
    ...
    _data.fields.add(MapEntry('captions', jsonEncode(captions)));
    final _options = _setStreamType<ChaletImageUploadResponse>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
  ...
  @override
  Future<void> deleteChaletImage(int chaletId, int imageId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<ChaletImageModel> updateChaletImage(
    ...
    final _options = _setStreamType<ChaletImageModel>(
  ...
  Future<PaginatedChaletResponse> getPublicChaletsPaginated({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaginatedChaletResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/chalets/browse/',
  ...
  Future<PublicChaletModel> getPublicChaletDetail(int id) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PublicChaletModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
