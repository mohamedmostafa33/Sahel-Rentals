...
part of 'chalet_api_service.dart';
...
class _ChaletApiService implements ChaletApiService {
  _ChaletApiService(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  ...
  @override
  Future<List<PublicChaletModel>> getPublicChalets() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PublicChaletModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<PublicChaletModel> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              PublicChaletModel.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
