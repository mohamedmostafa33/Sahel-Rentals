...
class _ChatRemoteDataSource implements ChatRemoteDataSource {
  ...
  Future<List<ChatRoomModel>> getChatRooms() async {
    ...
    final _options = _setStreamType<List<ChatRoomModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<ChatRoomModel> _value;
    try {
      _value = _result.data!
  ...
  @override
  Future<ChatRoomModel> createOrGetChatRoom(Map<String, dynamic> body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<ChatRoomModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<List<MessageModel>> getMessages(int chatRoomId) async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<MessageModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '/api/messaging/chat-rooms/${chatRoomId}/messages/',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
  ...
  Future<MessageModel> sendMessage(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<MessageModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '/api/messaging/chat-rooms/${chatRoomId}/send_message/',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
